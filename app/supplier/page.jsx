  ...
  return (
    <>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .page {
          ...
          padding: 48px 32px;
          background: radial-gradient(ellipse at 20% 30%, rgba(180,140,255,0.06) 0%, transparent 60%),
                      radial-gradient(ellipse at 80% 70%, rgba(80,40,160,0.08) 0%, transparent 60%),
                      #000005;
        }
      ...
      <div className="page">
        ...
        {/* ---- তোমার Supplier content এখানে যোগ করো ---- */}
        <div className="placeholder">
          <p>Supplier content coming soon</p>
        </div>
      </div>
    </>
  )
