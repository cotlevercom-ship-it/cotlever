<style>{`
  ...
  /* T hits L, L slides away */
  @keyframes leverSlide {
    0%   { transform: translateX(0px); }
    30%  { transform: translateX(0px); }   /* pause, T & L touching */
    45%  { transform: translateX(12px); }  /* L gets hit, flies right */
    65%  { transform: translateX(12px); }  /* held out */
    85%  { transform: translateX(0px); }   /* returns */
  ...
  @keyframes gleam {
    ...
    45%  { background-position: 50% 0; }  /* gleam hits on impact */
